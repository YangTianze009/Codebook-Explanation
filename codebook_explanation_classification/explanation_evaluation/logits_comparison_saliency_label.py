...
def main(args):
    ...
    for target_label in tqdm(range(1000), desc="Processing labels"):
        csv_path = f"/data2/ty45972_data2/taming-transformers/codebook_explanation_classification/results/Explanation/generated_data/label/Net{args.model}/label_activation_statistics_train/label_{target_label}.csv"
    ...
    output_csv = f"logits_probs_diff_all_models_top{args.top_n}_token{args.token_num}.csv"
