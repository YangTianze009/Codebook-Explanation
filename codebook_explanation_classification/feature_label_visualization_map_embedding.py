...
def main(args):
    ...
    feature_visualization_map_path = f"feature_visualization_map/label/{target_label}/"
    ...
    for token_feature_map in token_feature_maps:
        ...
        token_feature_map.save(feature_visualization_map_path + "token_feature_map_embedding.png")
